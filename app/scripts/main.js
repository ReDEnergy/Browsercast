require.config({
	paths: {
		...
		touchpunch: "libs/jquery-ui-touch-punch",
		"jquery.multisortable": "libs/jquery.multisortable",
		...
		browsercast : '../bundles/app/browsercast',
...
require([
	...
	function(Handlebars, lang, template,
			empty, config, registry, StrutLoader,
			bootstrap, ContextMenu, tp, dss) {
		'use strict';
